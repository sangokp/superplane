...
import { describePackageVersionMapper } from "./codeartifact/describe_package_version";

export const componentMappers: Record<string, ComponentBaseMapper> = {
  "codeArtifact.describePackageVersion": describePackageVersionMapper,
...
export const eventStateRegistry: Record<string, EventStateRegistry> = {
  "codeArtifact.describePackageVersion": buildActionStateRegistry("retrieved"),

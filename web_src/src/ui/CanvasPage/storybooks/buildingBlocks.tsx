...
export const mockBuildingBlockCategories: BuildingBlockCategory[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        name: "aws-codeartifact-describe-package-version",
        label: "CodeArtifact Describe Package Version",
        description: "Describe a CodeArtifact package version",
        type: "component",
        outputChannels: [{ id: "default", label: "Default" } as any],
        configuration: [
          { key: "region", label: "Region", type: "string", required: true },
          { key: "domainName", label: "Domain Name", type: "string", required: true },
          { key: "repositoryName", label: "Repository Name", type: "string", required: true },
          { key: "packageFormat", label: "Package Format", type: "string", required: true },
          { key: "packageNamespace", label: "Package Namespace", type: "string", required: false },
          { key: "packageName", label: "Package Name", type: "string", required: true },
          { key: "packageVersion", label: "Package Version", type: "string", required: true },
        ],
        icon: "cloud",
        color: "orange",
      },
